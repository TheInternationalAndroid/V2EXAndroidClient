...
public class WrapperListSampleVM extends EndLessListRespVM<WrapperListSampleContract.Presenter, WrapperListSampleContract.View, TestEntity> {
    ...
    public WrapperListSampleVM(WrapperListSampleContract.Presenter presenter, WrapperListSampleContract.View view, LinearLayoutManager layoutManager, StateListAdapter<TestEntity> adapter) {
