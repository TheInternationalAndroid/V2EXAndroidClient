...
public class RayListNoToolbarVM extends EndLessListRespVM<RayListNoToolbarContract.Presenter, RayListNoToolbarContract.View, TestEntity> {
    ...
    public RayListNoToolbarVM(RayListNoToolbarContract.Presenter presenter, RayListNoToolbarContract.View view, LinearLayoutManager layoutManager, StateListAdapter<TestEntity> adapter) {
