...
public interface MockSamplesContract {

    @PerActivity
    @Component(modules = {MockSamplesVMModule.class}, dependencies = ActivityComp.class)
    interface Comp extends ActivityComp {
        void inject(MockSamplesActivity activity);
    }
